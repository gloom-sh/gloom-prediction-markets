...
import { resolvePaneInstance } from "gloomberb/types/config";
...
export { predictionMarketsHeadless } from "./headless";
export { predictionChartSeriesCapability } from "./capability";
...
export const predictionMarketsPlugin: GloomPlugin = {
  ...
  homepage: "https://github.com/gloom-sh/gloom-prediction-markets",
  toggleable: true,

  // Public REST over HTTPS on every renderer, plus a Polymarket websocket for
  // live books and trades where the runtime has one. The hosts are declared so
  // the hosted web app proxies them: neither venue sends CORS headers for the
  // read endpoints this pane uses.
