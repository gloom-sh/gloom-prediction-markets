...
import { createDefaultConfig, type AppConfig } from "gloomberb/types/config";
...
export { MemoryPluginPersistence as MemoryPersistence } from "gloomberb/test-support";
        ...
        JSON.stringify({
          trades: [
            ...
            },
            {
              ...
              count_fp: "40",
              created_time: "2026-04-01T00:01:00Z",
            },
          ],
        }),
        { status: 200 },
